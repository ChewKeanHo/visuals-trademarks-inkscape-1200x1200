# Inkscape Trademarks Logo 1200x1200 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x1200.svg)](#)

The Inkscape Trademarks Logo. They published clear trademark guidelines and
...
This project re-draws Inkscape Trademarks Logo specifically for 1200x1200 size.
...
While not specified by Inkscape, please ensure the outputs are also web ready.
Refer:
...
```
--------------------------------------------------------------------------------
Title: Inkscape Trademarks Logo 1200x1200
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-inkscape-1200x1200
UUID: 5A8C0227-AAD2-4288-8FAB-97703553E5A2
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-02-03
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-inkscape-1200x1200
--------------------------------------------------------------------------------
```
...
> COMPLY WITH INKSCAPE TRADEMARK REQUIREMENTS
> (Read: https://inkscape.org/about/branding)**.
>
